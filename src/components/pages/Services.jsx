  ...
  return (
    <section ref={ref} id="service" className='mx-auto px-5 mb-5'>
      ...
      <div className='flex flex-col space-y-5 items-center md:flex-row md:space-x-2 md:justify-between py-5 my-12 '>
        <div className='h-auto w-[300px] py-5 px-3 flex flex-col items-center rounded-md border border-[#6c63ff] shadow-lg '>
          <div className=''>
        ...
        <div className='h-auto w-[300px] px-3 py-5  flex flex-col items-center shadow-lg rounded-md border border-[#6c63ff]'>
          <div>
        ...
        <div className='h-auto w-[300px] container flex flex-col items-center px-3 py-5 shadow-lg rounded-md border border-[#6c63ff]'>
          <div>

...
const Project = ({ project }) => {
  ...
  return (
    ...
    <div className="relative rounded-sm  overflow-hidden group">
      <img className="w-full h-full object cover" src={project.image} alt="Project Image" />
      <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-50 transition-opacity duration-400"></div>
